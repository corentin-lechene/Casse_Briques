...
enum language_index {
    ...
    lang_ending_opening,
    lang_loading,
    lang_loading_players,
    lang_you_won,
    lang_you_will_be_better,
    lang_play_with_this_map,
    lang_yes,
    lang_no,
    lang_leave,
    lang_your_choice,
    lang_sad,
    lang_enter_number_of_player,
    lang_your_info_connexion,
    lang_ip,
    lang_port,
    lang_error_connexion,
    lang_ip_incorrect,
    lang_port_incorrect,
    lang_enter,
    lang_enter_pseudo,
